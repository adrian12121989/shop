    ...
    */
    ...
    $html = <<<EOD
    <h1>4G EXPERIENCE EXPENDITURE REPORT.</h1>
EOD;
	...
	* */
	...
	$sum = 0;
	$count = 1;
	foreach($exp as $record){
		$html .= '<tr>
			<td style = "border:1px solid black">'.ucwords($record->exp_name).'</td>
			<td style = "border:1px solid black">'.ucwords($record->payee_name).'</td>
			<td style = "border:1px solid black">'.number_format($record->amount).'</td>
			<td style = "border:1px solid black">'.ucwords($record->exp_by).'</td>
			<td style = "border:1px solid black">'.$record->exp_date.'</td>
	...
	$pdf->Ln(4);
	$pdf->writeHTML('Total amount of cash used in the expenditure ', true, false, true, false, 'R');
...
$pdf->Text($myX, $myY,"4G EXPERIENCE EXPENDITURE REPORT");
$pdf->StopTransform();
