    ...
    */
    ...
    $html = <<<EOD
    <h1>4G EXPERIENCE SOLD DEVICES REPORT.</h1>
EOD;
	...
	* */
	...
	$sum = 0;
	$count = 1;
	foreach($sold_devices as $record){
		$html .= '<tr>
			<td style = "border:1px solid black">'.$record->dev_name.'</td>
			<td style = "border:1px solid black">'.$record->dev_number.'</td>
			...
			<td style = "border:1px solid black">'.$record->sold_date.'</td>
			<td style = "border:1px solid black">'.ucwords($record->sold_by).'</td>
		</tr>';
