	...
	<h3>Here you can view the devices status report.</h3>
	<br>
	<h4 style = "">Please select date range to view report.</h4>
	<?php  echo form_open('Home/device_status_report_pdf', 'class="form-horizontal role="form""'); ?>
