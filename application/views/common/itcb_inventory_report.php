...
EOD;
	...
	* */
	...
	$count =1;
	$sum = 0;
	foreach($invents as $record){
		$html .= '<tr>
			<td style = "border:1px solid black">'.$record->item_name.'</td>
			<td style = "border:1px solid black">'.$record->work_status.'</td>
			<td style = "border:1px solid black">'.number_format($record->item_value).'</td>
			<td style = "border:1px solid black; width:20%">'.$record->location.'</td>
			<td style = "border:1px solid black">'.$record->custodian.'</td>
			<td style = "border:1px solid black">'.ucwords($record->registered_by).'</td>
			<td style = "border:1px solid black; width:20%">'.$record->date.'</td>
		</tr>';
	...
	$pdf->Ln(4);
	$pdf->writeHTML('Total costs for all properties in this report', true, false, true, false, 'R');
